  ...
  return (
    <div className="relative flex flex-col items-center mx-auto min-h-dvh  bg-white">
      <header className="pt-27.25 mr-20">
        <h1 className="text-[22px] w-68 font-bold leading-8.75 text-[#551F1C]">
          안녕하세요, 부스 관리자님 로그인을 완료해주세요.
        </h1>
      </header>

      <div className="mt-21.25 flex w-87.5 flex-col gap-6.25 ">
      ...
      <div className="flex mt-auto w-full justify-center items-center h-28 shadow-[0_-1px_7px_-2px_rgba(0,0,0,0.25)]">
        <OrderButton width="21.5rem" height="3.25rem" color="#FE5F54" buttonName="로그인" />
      </div>
    </div>
  );
}
