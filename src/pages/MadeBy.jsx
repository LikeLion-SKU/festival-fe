...
const CORE_MEMBERS = [
  { name: '최병조', role: '촬영팀 팀장 23' },
  { name: '윤의현', role: '방역/안전팀 팀장 23' },
  { name: '정원조', role: '정원팀 팀장 23' },
  { name: '정바다', role: '운영팀 팀원 21' },
  { name: '심은교', role: '운영팀 팀원 23' },
  { name: '최하현', role: '촬영팀 팀원 23' },
  { name: '태웅제', role: '촬영팀 팀원 23' },
  { name: '장영진', role: '방역/안전팀 팀원 21' },
  { name: '박승아', role: '방역/안전팀 21' },
  { name: '김지유', role: '피켓팀 팀장 24' },
  { name: '송은태', role: '피켓팀 팀장 24' },
  { name: '김태건', role: '피켓팀 팀장 24' },
  { name: '박지혜', role: '피켓팀 24' },
  { name: '노유승', role: '피켓팀 팀원 24' },
  { name: '백순연', role: '피켓팀 팀원 24' },
  { name: '변정현', role: '음향팀 팀장 24' },
  { name: '장규민', role: '음향팀 팀원 24' },
];
