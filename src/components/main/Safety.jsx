  ...
  return (
    ...
    >
      <img
        ...
        alt=""
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-[-54.1rem] z-[1] w-[28.125rem] max-w-none -translate-x-1/2 object-cover"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-[7.5rem] z-[2] h-[22rem] w-[28.125rem] max-w-none -translate-x-1/2"
        style={{
          background:
