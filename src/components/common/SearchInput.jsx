export default function SearchInput({ placeholder, value, onChange }) {
  return (
    <div className="flex items-center justify-between px-[1.25rem] h-[3.25rem] border border-[#A0A0A0]/40 bg-[#353535]/20">
      <input
        type="text"
        value={value}
        onChange={onChange}
        placeholder={placeholder}
        className="flex-1 bg-transparent text-white text-[0.875rem] font-semibold placeholder:text-[#A0A0A0] outline-none"
